...
exports.MonthPipe = void 0;
const core_1 = require("@angular/core");
let MonthPipe = exports.MonthPipe = (() => {
    ...
    let _classThis;
    var MonthPipe = _classThis = class {
        transform(sessions, selectedDate) {
            if (selectedDate === '1') {
    ...
    __setFunctionName(_classThis, "MonthPipe");
    (() => {
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name }, null, _classExtraInitializers);
        MonthPipe = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MonthPipe = _classThis;
})();
